...
echo ""
echo "Option 1: Using brew fetch (after tap is updated):"
echo "  brew fetch p4puniya/macolint/macolint"
echo "  # Copy the SHA256 from the output and update the formula"
echo ""
echo "Option 2: Manual calculation:"
echo "  curl -L https://github.com/${GITHUB_USER}/${REPO}/archive/v${VERSION}.tar.gz | shasum -a 256"
echo "  # Copy the SHA256 and update Formula/macolint.rb"
